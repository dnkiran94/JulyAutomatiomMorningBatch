...
public class XPathAxesDemo {
	...
	static void navigate()
	{
		try
		{
			oBrowser.get("file:///E:/Selenium/XPathAxes_03_Sept_2021/WebTableHTML.html");
			Thread.sleep(4000);
		}catch(Exception e)
		{
			e.printStackTrace();
	...
	static void selectCityNameForSachinTendulkar()
	{
		try
		{
	//	 oBrowser.findElement(By.xpath("//td[text()='Sachin Tendulkar']/following-sibling::td/following-sibling::td/select/option[3]")).click();
	...
	static void fromRahulDravidFor2ndSecondEnterSalary()
	{
		try
		{
		 oBrowser.findElement(By.xpath("//td[text()='Rahul Dravid']/following::tr/following::tr/td[6]/input")).sendKeys("21345");
		 Thread.sleep(2000);
		}catch(Exception e)
		{
			e.printStackTrace();
	...
	{
		oBrowser.findElement(By.xpath("//input[@id='edit4']/ancestor::tr/ancestor::table")).getAttribute("id");
	}
